...
(async () => {
    ...
    try {
        await page.goto('http://127.0.0.1:5173/admin-login', { waitUntil: 'networkidle0' });
        ...
        await page.goto('http://127.0.0.1:5173/admin/attendance', { waitUntil: 'networkidle0' });
        ...
        await page.goto('http://127.0.0.1:5173/employee-dashboard', { waitUntil: 'networkidle0' });
