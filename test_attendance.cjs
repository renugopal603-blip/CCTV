...
(async () => {
    ...
    try {
        ...
        await page.goto('http://localhost:5173/admin/attendance', { waitUntil: 'networkidle0' });
        ...
        await page.goto('http://localhost:5173/employee-dashboard', { waitUntil: 'networkidle0' });
