...
(async () => {
    ...
    try {
        ...
        await page.goto('http://localhost:5174/admin/attendance', { waitUntil: 'networkidle0' });
        ...
        await page.goto('http://localhost:5174/employee-dashboard', { waitUntil: 'networkidle0' });
