...
import { FiPackage, FiSettings, FiClock, FiPlusCircle, FiHelpCircle, FiChevronRight, FiShoppingBag } from 'react-icons/fi'
...
export default function CustomerDashboard() {
    ...
    const quickActions = [
        { title: 'Place New Order', desc: 'Browse and purchase gear', link: '/products', icon: <FiShoppingBag /> },
